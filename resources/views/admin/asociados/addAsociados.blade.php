...
<div class="col-md-12">
    <div class="card card-gray">
        ...
        <form method="POST" action="{{ route('admin.addAsociados') }}" autocomplete="off">
        @csrf
        <div class="card-body">
            ...
            <div class="d-flex justify-content-start">
                ...
                <div class="col-sm-4">
                    <div class="form-group" id="theState">
                        ...
                        <input type="text" id="txt_estado" name="txt_estado" class="form-control text-uppercase " placeholder="Estado">
                    </div>
                </div>
            </div>
            <div class="d-flex justify-content-start">
            ...
            <div class="d-flex justify-content-start">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txt_min_cliente" name="txt_min_cliente" class="form-control" placeholder="Mínimo de clientes">
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        <label for="txt_max_cliente">Máximo de Clientes</label>
                        <input type="text" id="txt_max_cliente" name="txt_max_cliente" class="form-control" placeholder="Máximo de clientes">
                    </div>
                </div>
            </div>
            <div class="d-flex justify-content-start">
                    ...
                    <div class="form-group">
                        ...
                        <select type="select" id="txt_operador" name="txt_operador" class="form-control select2 " required>
                            ...
                            @foreach($operadores as $operador)
                                <option {{ old('txt_operador') == $operador->id ? 'selected' : '' }} value="{{$operador->id}}">{{$operador->getFullname()}}</option>
                            @endforeach
                        </select>
                        @error('userType')
                            <span class="invalid-feedback" role="alert">

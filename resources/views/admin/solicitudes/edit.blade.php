            ...
            <div class="d-flex justify-content-start"> 
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txt_tipo_negocio" name="txt_tipo_negocio" class="form-control text-uppercase" placeholder="Tipo de negocio" required value="{{$solicitud->tipo_negocio}}">
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        <label for="txt_antiguedad_negocio">Antiguedad del Negocio</label>
                        <input type="text" id="txt_antiguedad_negocio" name="txt_antiguedad_negocio" class="form-control text-uppercase" placeholder="Antiguedad del negocio" required value="{{$solicitud->antiguedad_negocio}}">
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
            ...
            <div class="d-flex justify-content-start">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txt_dependientes_economicos" name="txt_dependientes_economicos" class="form-control" placeholder="Dependientes Economicos" required maxlength="3" value="{{$solicitud->dependientes_economicos}}">
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        <label for="txt_ingreso_mensual">Ingreso Mensual</label>
                        <input type="text" id="txt_ingreso_mensual" name="txt_ingreso_mensual" class="form-control" placeholder="0.00" onchange="capacidadPago()" value="{{number_format($solicitud->ingreso_mensual,2)}}">
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        <label for="txt_gasto_mensual">Gasto Mensual</label>
                        <input type="text" id="txt_gasto_mensual" name="txt_gasto_mensual" class="form-control" placeholder="0.00" onchange="capacidadPago()" value="{{number_format($solicitud->gasto_mensual,2)}}">
                    </div>
                </div>
            </div>
            <div class="d-flex justify-content-start">
                <div class="col-sm-3">
                    <div class="form-group">
                        <label for="txt_producto" class="">Producto</label>
                        <select type="select" id="txt_producto" name="txt_producto" class="form-control select2 " required onchange="cargarProducto();">
                            <option value="">Seleccionar</option>
                            @foreach($productos as $producto)
                                <option {{ old('txt_producto') == $producto->id ? 'selected' : ($opcionProducto != "N/A" ? ($opcionProducto == $producto->id ? 'selected' : '')  : '') }} value="{{$producto->id}}">{{$producto->nombre}}</option>
                            @endforeach
                        </select>
                        @error('userType')
                            <span class="invalid-feedback" role="alert">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        {{-- <select class="form-control" id="txt_tasa" name="txt_tasa">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        {{-- <select class="form-control" id="txt_plazo" name="txt_plazo">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        {{-- <select class="form-control" id="txt_frecuencia_pago" name="txt_frecuencia_pago">
            ...
            <div class="d-flex justify-content-start">
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txt_ciclo" name="txt_ciclo" class="form-control" placeholder="Ciclo" value="{{$solicitud->ciclo}}">
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        <label for="txt_monto_solicitado">Monto Solicitado</label>
                        <input type="text" id="txt_monto_solicitado" name="txt_monto_solicitado" class="form-control" placeholder="0.00" onchange="capacidadPago(); cuota();" value="{{number_format($solicitud->monto_solicitado,2)}}">
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txt_cuota" name="txt_cuota" class="form-control" placeholder="0.00" value="{{$solicitud->cuota}}" readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-start">
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txt_fsolicitud" name="txt_fsolicitud" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" value="{{ \Carbon\Carbon::parse($solicitud->fecha_solicitud)->format('d/m/Y')}}" onchange="calculaFechDesemb(); calculaFechaPpago(); calculaFechaVenc();">
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txt_fprimer_pago" name="txt_fprimer_pago" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" placeholder="dd/mm/yyyy" value="{{ \Carbon\Carbon::parse($solicitud->fecha_primer_pago)->format('d/m/Y')}}" readonly>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        <label for="txt_fvencimiento">Fecha de Vencimiento</label>
                        <input type="text" id="txt_fvencimiento" name="txt_fvencimiento" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" placeholder="dd/mm/yyyy" value="{{ \Carbon\Carbon::parse($solicitud->fecha_vencimiento)->format('d/m/Y')}}" readonly>
                    </div>
                </div>
            </div>
...
<script>
    ...
    cargarDetalles({{ $solicitud->cliente_id}});

    cargarProducto({{ $solicitud->producto_id}});
    
    function cargarProducto(id){
        id = document.getElementById("txt_producto").value;
        $.ajax({
            url: "{{ asset('admin/solicitud/productos') }}/" + id,
            type: 'get',
            cache: false,
            beforeSend(){

...
<div class="col-md-12">
    <div class="card card-gray"> 
        ...
        <form method="POST" action="{{ route('admin.cobro.store') }}" autocomplete="off">
            @csrf
            <div class="card-body">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select type="select" id="txt_cuenta_cheque" name="txt_cuenta_cheque" class="form-control select2 ">
                                            <option value="">Selecciona</option>
                                            @foreach($bancos as $banco)
                                                <option {{ old('txt_cuenta_cheque') == $banco->id ? 'selected' : '' }} value="{{$banco->cuentas_id}}">{{$banco->nombre_caja}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
        ...
        <div class="card-footer">
            <input type="submit" class="btn btn-primary float-right" value="Cobrar">
        </div>
    </form> 
    </div>
</div>

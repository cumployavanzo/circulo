...
@section('content')
 <div class="card card-gray">
        ...
        <form action="{{ route('admin.addNodeducible') }}" method="POST" autocomplete="off"> 
            @csrf
            <div class="card-body">
                ...
                <div class="card-footer">
                    <a type="button" href="{{ route('admin.noDeducible.index') }}" class="btn btn-primary float-right">Terminar</a>
                </div>    
                @endif
            </div><!-- /.card-body -->                                       
...
<script>
    ...
    function cargarArticulo(){
        ...
        $.ajax({
            url: "{{ asset('admin/noDeducible/articulosNoDeducible') }}/" + id,
            type: 'get',
            cache: false,
            beforeSend(){
    ...
    function cargarRfc(){
        ...
        $.ajax({
            url: "{{ asset('admin/noDeducible/rfcProveedorNoDeducible') }}/" + id,
            type: 'get',
            cache: false,
            beforeSend(){
    ...
    function cargarArea(){
        ...
        $.ajax({
            url: "{{ asset('admin/noDeducible/areaPersonalsNoDeducible') }}/" + id,
            type: 'get',
            cache: false,
            beforeSend(){

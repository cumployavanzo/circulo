...
class Domicilio implements ModelInterface, ArrayAccess
{
    ...
    protected static $apihubTypes = [
        ...
        'ciudad' => 'string',
        'estado' => '\App\CirculoCredito\Simulacion\Model\CatalogoEstados',
        'cp' => 'string',
        'fecha_residencia' => 'string',
        'numero_telefono' => 'string',
        'tipo_domicilio' => '\App\CirculoCredito\Simulacion\Model\CatalogoTipoDomicilio',
        'tipo_asentamiento' => '\App\CirculoCredito\Simulacion\Model\CatalogoTipoAsentamiento',

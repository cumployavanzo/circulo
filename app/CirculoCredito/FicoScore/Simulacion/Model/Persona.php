...
class Persona implements ModelInterface, ArrayAccess
{
    ...
    protected static $apihubTypes = [
        ...
        'curp' => 'string',
        'nacionalidad' => 'string',
        'residencia' => '\App\CirculoCredito\Simulacion\Model\CatalogoResidencia',
        'estado_civil' => '\App\CirculoCredito\Simulacion\Model\CatalogoEstadoCivil',
        'sexo' => '\App\CirculoCredito\Simulacion\Model\CatalogoSexo',
        'clave_elector_ife' => 'string',
        'numero_dependientes' => 'int',
        'fecha_defuncion' => 'string',
        'domicilio' => '\App\CirculoCredito\Simulacion\Model\Domicilio'
    ];

...
class GlobalGastosExport implements FromView, withEvents
{
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $event->sheet->getColumnDimension('A')->setWidth(55);//Tamaño de la columna N° PROVEEDOR
                $event->sheet->getColumnDimension('B')->setWidth(25);//Tamaño de la columna RFC
                $event->sheet->getColumnDimension('C')->setWidth(20);//Tamaño de la columna importe
                $event->sheet->getColumnDimension('D')->setWidth(20);//Tamaño de la columna del iva
                $event->sheet->getColumnDimension('E')->setWidth(20);//Tamaño de la columna del total
    ...
    {
        return view('admin.gastos.gastosglobalexport', [
            'data' => $this->data
        ]);
    }
}
